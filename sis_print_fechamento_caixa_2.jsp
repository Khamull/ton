...
<tr>
 <td colspan="2" align="left"><a href="javascript: window.close()"> [Fechar] </a></td>
 <td width="336" align="right"><a href="javascript: window.print() "> [Imprimir] </a></td>
</tr>
<tr>
...
<%if(rs06.next()){ %>
<tr>
  <td width="188" rowspan="7" align="left" valign="top"><img src="relatorios/images/logo_relatorio.png" border="0" title="Iprimir Relatorio"></td>
  <td colspan="3" align="center" valign="top"><%=rs06.getString("nomeFantasia")%></td>
  </tr>
<tr>
  <td colspan="3" align="left" valign="top"><%=rs06.getString("rua") %>, <%=rs06.getString("numero") %></td>
  </tr>
<tr>
  <td colspan="3" align="left" valign="top"><%=rs06.getString("bairro") %></td>
  </tr>
<tr>
  <td colspan="3" align="left" valign="top"><%=rs06.getString("cidade") %> - <%=rs06.getString("uf") %></td>
  </tr>
<tr>
  <td colspan="3" align="left" valign="top"><%=rs06.getString("telefone") %></td>
  </tr>
<tr>
  <td colspan="3" align="left" valign="top">CNPJ: <%=rs06.getString("cnpj") %></td>
  </tr>
<tr>
  <td colspan="3" align="left" valign="top">Insc. Estadual: <%=rs06.getString("inscEstadual") %></td>
  </tr>
<%} %>
<tr>
 <td align="center" colspan="3"><hr></td>
