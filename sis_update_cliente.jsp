...
maxlength="40" value="<%=rs.getString("clienteRazaoSocial")%>"/></div></td>
       </tr>
       <tr align="left">
...
(form1.clienteCnpj)" onKeyPress="MascaraCNPJ(form1.clienteCnpj);" value="<%=rs.getString("clienteCnpj")%>" size="14" maxlength="18"></div><div id="cnpjInp"><input 

name="clienteCpf" id="cpf" type="text" style="width:120px" onBlur="valida()" onKeyPress="MascaraCPF(form1.clienteCpf);" value="<%=rs.getString("clienteCnpj")%>" 

size="14" maxlength="14"></div></td>
        <td align="left"><div id="inscEstInput" style="display:none"><input type="text" name="clienteInscEstadual" id="inscEst" size="14" maxlength="15" 

style="width:120px" onKeyPress="MascaraInscEst(form1.inscEst)" value="<%=rs.getString("clienteInscEstadual")%>"></div></td>
...
onKeyPress="return numero(this)" value="<%=rs.getString("clienteInscMunicipal")%>"></div></td>
       </tr>
       <tr>
        <td height="20" colspan="3" align="center" valign="middle" bgcolor="#CCCCCC">Busque o Endere&ccedil;o pelo CEP:           <input name="cep" id="cep" 

type="text" style="width:120px" onKeyPress="return numero(this)" maxlength="8" onBlur="getEndereco()" size="14" value="<%=rs.getString("clienteCep")%>" /></td>
       </tr>
       <tr>
...
("clienteNumero")%>" size="14" maxlength="6"/></td>
       </tr>
       <tr>
...
maxlength="200"/></td>
          ...
          <tr align="left">
           <td><input name="clienteTelefone" type="text" id="clienteTelefone" style="width:120px" value="<%=rs.getString("clienteTelefone")%>" size="14" 

onKeyPress="MascaraTelefone(form1.clienteTelefone);" maxlength="14"  onBlur="ValidaTelefone(form1.clienteTelefone);"></td>
...
onKeyPress="MascaraTelefone(form1.clienteCelular);" maxlength="15"  onBlur="ValidaTelefone(form1.clienteCelular);">
