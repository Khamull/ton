...
function tipoCliente(tipoCli){
	...
	if(tipo == "0"){
		...
		//Inscrição Municipal Alterado para Aproveitamento no Cadastro de Pessoa Fisica como RG
    ...
    <!--PRIMEIRA COLUNA-->
     <td valign="top">
      ...
      <table align="center">
       ...
       <tr>
        <td colspan="3" align="left"><input name="clienteNomeFantasia" type="text" id="clienteNomeFantasia" value="<%=rs.getString("clienteNomeFantasia")%>" size="70" 
...
maxlength="40" readonly="readonly"/></td>
       ...
       <tr>
        <td colspan="3" align="left"><div id="razSociInput" style="display:none"><input type="text" name="clienteRazaoSocial" id="clienteRazaoSocial" size="70" 

maxlength="40" value="<%=rs.getString("clienteRazaoSocial")%>" readonly="readonly"/></div></td>
       </tr>
       <tr align="left">
        ...
        <td><div id="inscMun" style="display:none" >Inscriçao Municipal</div><div id="rg">RG</div></td>
       </tr>
       <tr>
        <td align="left"><input name="clienteCnpj" type="text" id="clienteCnpj" style="width:120px" onKeyPress="return numero(this)" value="<%=rs.getString

("clienteCnpj")%>" size="14" maxlength="14" readonly="readonly"></td>
        <td align="left"><div id="inscEstInput" style="display:none"><input type="text" name="clienteInscEstadual" id="clienteInscEstadual" size="14" maxlength="14" 

style="width:120px" onKeyPress="return numero(this)" value="<%=rs.getString("clienteInscEstadual")%>" readonly="readonly"></div></td>
        <td align="left"><div id="inscMunInput"><input type="text" name="clienteInscMunicipal" id="clienteInscMunicipal" size="14" maxlength="14" style="width:120px" 

onKeyPress="return numero(this)" value="<%=rs.getString("clienteInscMunicipal")%>" readonly="readonly"></div></td>
       </tr>
       <tr>
       ...
       <tr>
        <td colspan="2" align="left"><input name="clienteEndereco" type="text" id="clienteEndereco" value="<%=rs.getString("clienteEndereco")%>" size="45" 

maxlength="40" readonly="readonly"/></td>
        <td align="left"><input name="clienteNumero" type="text" id="clienteNumero" style="width:120px" onKeyPress="return numero(this)" value="<%=rs.getString

("clienteNumero")%>" size="14" maxlength="6" readonly="readonly"/></td>
       </tr>
       <tr>
       ...
       <tr>
        <td colspan="2" align="left"><input name="clienteBairro" type="text" id="clienteBairro" value="<%=rs.getString("clienteBairro")%>" size="45" maxlength="40" 

readonly="readonly"/></td>
        <td align="left"><input name="clienteCep" type="text" id="clienteCep" style="width:120px" onKeyPress="return numero(this)" value="<%=rs.getString

("clienteCep")%>" size="14" maxlength="10" readonly="readonly"/></td>
       </tr>
       <tr>
       ...
       <tr>
        <td colspan="2" align="left"><input name="clienteCidade" type="text" id="clienteCidade" value="<%=rs.getString("clienteCidade")%>" size="45" maxlength="40" 
...
readonly="readonly"/></td>
        ...
        <td valign="top">
         ...
         <table align="center">
          ...
          <tr align="left">
            <td colspan="3" align="left"><input name="clienteComplemento" type="text" id="clienteComplemento" value="<%=rs.getString("clienteComplemento")%>" size="70" 
...
maxlength="200" readonly="readonly"/></td>
          ...
          <tr align="left">
            <td colspan="3"><input name="clienteContato" type="text" id="clienteContato" value="<%=rs.getString("clienteContato")%>" size="70" maxlength="30" 
...
readonly="readonly"/></td>
          ...
          <tr align="left">
           <td><input name="clienteTelefone" type="text" id="clienteTelefone" style="width:120px" value="<%=rs.getString("clienteTelefone")%>" size="14" maxlength="14" 

readonly="readonly"></td>
           <td><input name="clienteFax" type="text" id="clienteFax" style="width:120px" value="<%=rs.getString("clienteFax")%>" size="14" maxlength="14" 
...
readonly="readonly"></td>
          ...
          <tr align="left">
          <td align="left"><input name="clienteCelular" type="text" id="clienteCelular" style="width:120px" value="<%=rs.getString("clienteCelular")%>" size="14" 
...
maxlength="14" readonly="readonly">
          ...
          <tr align="left">
            <td colspan="3"><input name="clienteEmail" type="text" id="clienteEmail" style="text-transform:lowercase;" value="<%=rs.getString("clienteEmail")%>" 

size="70" maxlength="100" readonly="readonly"/></td>
          </tr>
          <tr align="left">
            <td width="131">Site</td>
          </tr>
          <tr align="left">
            <td colspan="3"><input name="clienteSite" type="text" id="clienteSite" style="text-transform:lowercase;"  value="<%=rs.getString("clienteSite")%>" 
