...
<%
//Pesquisa os bancos ativos para realizar o depósito desse emprestimo
rs01 = st01.executeQuery(banco.listaBancos());
%>
...
if(request.getParameter("msg") != null){
	...
	msg = emprestimo.mensagem(numeroMsg);
}
%>
...
function verForm(){
	...
	if(contador == 0){
		alert("Emprestimo Gerado com Sucesso!");	
	}
...
<table align="center" style="width:450px; height:200px; border:1px solid #333">
 ...
 <form name="form1" method="post" action="sis_insert_manager_emprestimo.jsp" onsubmit="return verForm(this)">
 <table width="406" align="center" cellpadding="5" cellspacing="0">
 <%if(request.getParameter("msg") != null){ %>
  <tr>
 ...
 <%} %>
  <tr>
    <td colspan="2" align="center"><strong>CADASTRAR NOVO EMPRESTIMO</strong></td>
  </tr>
  <tr bgcolor="#CCCCCC">
    <td width="145" align="left">Valor Emprestado</td>
  ...
  <tr>
    <td colspan="2" align="center" bgcolor="#FFFFFF"><strong>GERAR UM CONTA A PAGAR DESSE EMPRESTIMO</strong></td>
    </tr>
  <tr>
    <td align="left" bgcolor="#E4E4E4">Favorecido</td>
    <td align="left" bgcolor="#E4E4E4"><input name="favorecido" type="text" size="50" maxlength="100" /></td>
  </tr>
  <tr>
...
1&ordf; Parcela</p></td>
  ...
  <tr>
   <td align="left" colspan="2"><input type="submit" class="botao" name="CADASTRAR" value="Gerar Emprestimo" /></td>
  </tr>
 </table>
 </form>
