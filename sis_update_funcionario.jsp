...
rs = st.executeQuery(cargo.listaCargosAtivos());
...
function verForm(){
	...
	if(document.form1.funcionarioNascimento.value == ""){
	alert("Favor informar a Data de Nascimento!");
	document.form1.funcionarioNascimento.focus();
	return false;	
	}
    ...
    <!--PRIMEIRA COLUNA-->
     <td valign="top">
      ...
      <table align="center">
       ...
       <tr>
        <td colspan="3" align="left"><input name="funcionarioNome" type="text" id="funcionarioNome" size="71" value="<%=rs01.getString("funcionarioNome")%>" maxlength="50"/></td>
       </tr>
       <tr>
       ...
       <tr>
        ...
        <select name="cargoID" style="width:380px;">
         ...
         <%while(rs.next()){%>
          <option value="<%=rs.getString("cargoID")%>"><%=rs.getString("cargoTitulo")%></option>
         <%}%>
       ...
       <tr>
        <td align="left"><input name="funcionarioNascimento" type="text" style="width:120px" size="14" onKeyPress="MascaraData(form1.funcionarioNascimento);" onBlur="validaDat(this,this.value)"  maxlength="10" value="<%=data%>" ></td>
        <td align="left"><input name="funcionarioRg" type="text" style="width:120px" size="14" maxlength="14" value="<%=rs01.getString("funcionarioRg")%>"  ></td>
        <td align="left"><input name="funcionarioCpf" id="cpf" type="text" style="width:120px" onBlur="valida()" onKeyPress="MascaraCPF(form1.funcionarioCpf);" size="14" maxlength="14" value="<%=rs01.getString("funcionarioCpf")%>"  ></td>
       </tr>
       <tr>
       ...
       <tr valign="middle" bgcolor="#CCCCCC">
         <td colspan="3" align="center" height="30">Busque o Endere&ccedil;o pelo CEP:           <input name="cep" id="cep" type="text" style="width:120px" onKeyPress="return numero(this)" maxlength="8" onBlur="getEndereco()" size="14" value="<%=rs01.getString("funcionarioCep")%>"  /></td>
         </tr>
       <tr>
       ...
       <tr>
        <td colspan="2" align="left"><input name="rua" id="rua" type="text" size="45" maxlength="40"value="<%=rs01.getString("funcionarioEndereco")%>" /></td>
        <td align="left"><input name="funcionarioNumero" type="text" style="width:120px" onKeyPress="return numero(this)" size="14" maxlength="6" value="<%=rs01.getString("funcionarioNumero")%>" /></td>
       </tr>
       <tr>
       ...
       <tr>
        <td colspan="2" align="left"><input name="bairro" id="bairro" type="text" size="45" maxlength="40" value="<%=rs01.getString("funcionarioBairro")%>" /></td>
        <td align="left">&nbsp;</td>
       </tr>
       <tr>
       ...
       <tr>
        <td colspan="2" align="left"><input name="cidade" id="cidade" type="text" size="45" maxlength="40" value="<%=rs01.getString("funcionarioCidade")%>" /></td>
        <td align="left">
        ...
        <td valign="top">
         ...
         <table align="center">
          ...
          <tr align="left">
           <td colspan="3" align="left"><input name="funcionarioComplemento" type="text" size="70" maxlength="100" value="<%=rs01.getString("funcionarioComplemento")%>" /></td>
          </tr>
          <tr align="left">
          ...
          <tr align="left">
            <td><input name="funcionarioTelefone" type="text" style="width:120px" size="14" onKeyPress="MascaraTelefone(form1.funcionarioTelefone);" maxlength="14"  onBlur="ValidaTelefone(form1.funcionarioTelefone);" value="<%=rs01.getString("funcionarioTelefone")%>" ></td>
            <td><input name="funcionarioCelular" type="text" style="width:120px" size="14" onKeyPress="MascaraTelefone(form1.funcionarioCelular);" maxlength="15"  onBlur="ValidaTelefone(form1.funcionarioCelular);" value="<%=rs01.getString("funcionarioCelular")%>" /></td>
          ...
          <tr align="left">
            <td colspan="3"><input name="funcionarioEmail" type="text" style="text-transform:lowercase;" size="70" maxlength="100" value="<%=rs01.getString("funcionarioEmail")%>" /></td>
          </tr>
          <tr align="left">
            <td>
