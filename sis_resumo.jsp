 	...
 	while(rs03.next()){
		if(rs03.getString("tipo").equals("R") && rs03.getString("vendaID").equals("0")){
			...
			valorEmCaixa -= rs03.getDouble("valor");	
 			...
 			valorEmCaixa -= rs03.getDouble("valor");
 		}else if(rs03.getString("tipo").equals("E")){
 			valorEmCaixa += rs03.getDouble("valor");
 		}
 	}
...
<tr>
 ...
 <table align="center" width="900" cellpadding="2" cellspacing="2">
  ...
  <tr bgcolor="<%=cor[j]%>">
   ...
   <td align="left"><%=dataLanc %></td>
   <td align="left"><%=rs01.getString("lancamentoID") %></td>
   <td colspan="2" align="left"><a href="sis_detalhe_emprestimo.jsp?emprestimoID=<%=rs01.getString("emprestimoID")%>" title="Informa&ccedil;&otilde;es sobre a Emprestimo">Emprestimo - <%=rs01.getString("favorecido")%></a></td>
   <td align="left"><font color="#009900"><%=valor %></font></td>
   <td align="left"></td>
   <td align="right">
   <%if(totalAtual <= 0){ %>
