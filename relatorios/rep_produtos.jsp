...
if(nivelUsuario.equals("2") || nivelUsuario.equals("3") || nivelUsuario.equals("4") || nivelUsuario.equals("5")){
   ...
   <table width="590" height="950" cellpadding="0" cellspacing="0" style="border:1px solid none" align="center">
    ...
    <%ln++; %>
     ...
     <%
      ...
      %>
        <tr>
         <td height="15" align="left"><strong>Preco Custo</strong></td>
         <td align="left"><strong></strong></td>
         <td align="left"><strong>Preco Venda</strong></td>
     ...
     <%
      ...
      %>        
        <tr>
         <td height="15" align="left"><%=formato.format(rs02.getDouble("precoCusto")) %></td>
         <td align="left"><strong></strong></td>
         <td align="left"><%=formato.format(rs02.getDouble("preco")) %></td>
