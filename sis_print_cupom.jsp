...
<tr>
  <td height="9" colspan="2"><%=rs01.getString("rua") %>, <%=rs01.getString("numero") %></td>
  </tr>
<tr>
  <td height="9" colspan="2"><%=rs01.getString("bairro") %></td>
  </tr>
<tr>
  <td height="20" colspan="2"><%=rs01.getString("cidade") %> - <%=rs01.getString("uf") %></td>
  </tr>
<tr>
  <td height="20" colspan="2"><%=rs01.getString("telefone") %></td>
  </tr>
<tr>
  <td height="20" colspan="2">CNPJ: <%=rs01.getString("cnpj") %></td>
  </tr>
<tr>
  <td height="20" colspan="2">Insc. Estadual: <%=rs01.getString("inscEstadual") %></td>
</tr>
<%}%>  
<tr>
...
<tr bgcolor="#CCCCCC">
 <td colspan="3" align="center"><strong>ITENS DA VENDA</strong></td>
</tr>
<tr>
...
%>
 ...
 <tr>
  <td width="142" align="left"><%=rs.getString("codigo")%></td>
  <td colspan="2" align="left"><%=rs.getString("tipo")%> <%=rs.getString("nome")%></td>
  </tr>
 <tr>
  <td align="left"><%=preco%> <%=rs.getString("unidade")%></td>
  <td width="125" align="left">qtd: <%=rs.getString("quantidade")%></td>
  <td width="307" align="left" bgcolor="#EEEEEE"><strong>total</strong> <%=total%></td>
 </tr>
 <tr>
...
<tr>
 <td colspan="2" align="left" bgcolor="#EEEEEE">Total do Pedido</td>
 <td align="right"><strong><%=total %></strong></td>
</tr>
<tr>
 <td colspan="2" align="left" bgcolor="#EEEEEE">Desconto</td>
 <td align="right"><%=desconto %></td>
</tr>
<%if(rs02.getDouble("desconto") > 0){%>
<tr>
 <td colspan="2" align="left" bgcolor="#EEEEEE">Total com Desconto</td>
...
<tr>
 <td colspan="2" align="left" bgcolor="#EEEEEE">Entrada</td>
 <td align="right"><%=pago%></td>
</tr>
<tr>
 <td colspan="2" align="left" bgcolor="#EEEEEE"><%=formaPagamento%></td>
 <td align="right"><%=faltaPagar%></td>
</tr>
<%}%>

<tr>
 <td colspan="2" align="left" bgcolor="#EEEEEE">Total Pago</td>
 <td align="right">
...
<tr>
 <td colspan="2" align="left" bgcolor="#EEEEEE">Troco</td>
...
<tr>
 <td height="15" colspan="3" align="center" bgcolor="#CCCCCC"><u>COMPROVANTE VENDA VALE</u></td>
</tr>
<tr>
 <td height="15" colspan="3"></td>
</tr>
